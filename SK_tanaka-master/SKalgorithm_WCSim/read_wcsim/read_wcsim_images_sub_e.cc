...
int read_wcsim_images_sub_e(const char* root_file, const char* image_file, const char* evt_file, int start_event_no, int end_event_no, bool verbose = true, bool electron = true)
{
