...
for opt, arg in opts:
    if opt == '-h':
        ...
        #object.
        try:
            FLAGS.set_parameters(SKinput.ParameterReadWrite(arg).read())
        except:
...
def train(data_set, plot=true):
    ...
    with tf.Graph().as_default():
        ...
        logits, weight_list, middle_steps = SKgraph.inference(images, data_set, FLAGS.dropout_prob)
        W_conv1, W_fc1, W_fc2, W_fc3 = weight_list[0], weight_list[1], weight_list[2], weight_list[3]	
        h_conv1, h_pool1, h_fc1, h_fc2 = middle_steps[0], middle_steps[1],middle_steps[2], middle_steps[3]
